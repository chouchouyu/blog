...
module.exports = [
	{
		...
		collapsable: true,
		children: [
			{ title: "让宇宙无敌的AlphaGo老师教你下围棋", path: "/diary/notes/让宇宙无敌的AlphaGo老师教你下围棋" },
			{ title: "我要带牙套啦～", path: "/diary/notes/我要带牙套啦" },
			{ title: "学英语的顿悟", path: "/diary/notes/学英语的顿悟" },
			{ title: "《七日掌握设计配色基础》读书笔记", path: "/diary/notes/《七日掌握设计配色基础》读书笔记" },
			{ title: "《华为的团队工作法》之(一)团队搭建", path: "/diary/notes/《华为的团队工作法》之(一)团队搭建" },
      { title: "《华为的团队工作法》之(二)人才评估", path: "/diary/notes/《华为的团队工作法》之(二)人才评估" },
			{ title: "《华为的团队工作法》之(三)人才培养", path: "/diary/notes/《华为的团队工作法》之(三)人才培养" },
			{ title: "《华为的团队工作法》之(四)干部任用", path: "/diary/notes/《华为的团队工作法》之(四)干部任用" },
			{ title: "《华为的团队工作法》之(五)企业文化", path: "/diary/notes/《华为的团队工作法》之(五)企业文化" },
			{ title: "《华为的团队工作法》之(六)薪酬激励", path: "/diary/notes/《华为的团队工作法》之(六)薪酬激励" },
      { title: "《华为的团队工作法》之(七)唤起内在驱动力", path: "/diary/notes/《华为的团队工作法》之(七)唤起内在驱动力" },
      { title: "《华为的团队工作法》之(八)保持活力", path: "/diary/notes/《华为的团队工作法》之(八)保持活力" },
      { title: "The Road Not Taken（by Robert Frost）", path: "/diary/notes/The Road Not Taken（by Robert Frost）" },
      { title: "[315打假]‘中国摩飞’居然不是摩飞？！", path: "/diary/notes/[315打假]‘中国摩飞’居然不是摩飞？！" },
    ],
	},
	// {
	//   title: "CSS",
